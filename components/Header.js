    ...
    <div className="container mx-auto px-4 sm:px-10 mb-4 sm:mb-8">
      <div className="flex justify-between border-b w-full border-gray-900 pt-4 pb-2 sm:py-8">
        ...
        <div className="hidden sm:block">
          <div className="flex">
            <div
              className="relative mt-2 align-middle text-white sm:text-gray-900 ml-4 font-semibold cursor-pointer"
              onClick={menuClick}
            >
              Blog
              <div
                className={classNames(
                  ...
                  "absolute z-50 -right-1/4 top-1/2 mt-4 p-8 pb-8 bg-white sm:text-gray-900 shadow-lg rounded-lg"
                )}
              >
            ...
            <div className="mt-2 align-middle text-white sm:text-gray-900 ml-4 font-semibold cursor-pointer">
        ...
        <div
          className={classNames(
            activeMenu ? "opacity-100 bg-black" : "opacity-90 bg-pink-600",
            "hamburger-menu sm:hidden w-10 h-10 p-2 rounded-lg shadow-lg"
          )}
          onClick={menuClick}
        >
      ...
      >
        <div className="absolute z-50 right-0 -top-1 bg-white shadow-2xl rounded-lg w-10/12">
          <div
            className="flex justify-center mt-12 text-center align-middle font-semibold cursor-pointer"
          ...
          <div
            className={classNames(
              ...
              "mt-6 w-max mx-auto cursor-pointer"
            )}
          >
            {categories.map((category) => (
          ...
          <div
            className="mt-12 text-center align-middle font-semibold cursor-pointer"
            onClick={menusFalse}
          >
            <Link href="/contact">Contact</Link>
          </div>
